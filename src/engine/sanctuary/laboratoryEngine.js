...
export const LAB_RESEARCH_DEFINITIONS = [
  ...
  },
  {
    ...
    group: "unlock",
    label: "Abrir Taller",
    description: "Permite trabajar blueprints y proyectos persistentes a largo plazo con estructura, sintonía y ascensión.",
    stationId: "deepForge",
  ...
  },
  {
    ...
    description: "Añade capacidad operativa al Taller.",
    stationId: "deepForge",
