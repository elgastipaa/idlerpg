...
const SUBVIEW_META = {
  achievements: {
    label: "Logros",
    description: "Coleccion, hitos y progreso secundario de cuenta.",
  },
  stats: {
    label: "Metricas",
  ...
  system: {
    label: "Sistema",
    description: "Herramientas de tester, replay, save e inspeccion avanzada.",
  },
};
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "start", gap: "12px", flexWrap: "wrap" }}>
          ...
          {activeSubview === "system" && (
            <div style={{ fontSize: "0.64rem", color: "var(--tone-violet, #7c3aed)", fontWeight: "900", maxWidth: "30ch", textAlign: "right", lineHeight: 1.45 }}>
              Esta vista mezcla replay, save, bot y tooling. No deberia competir con acciones de jugador normal.
            </div>
          )}
        </div>
        ...
        {activeSubview !== "system" && (
          <div style={{ ...panelStyle(), gap: "6px", padding: "10px 12px", background: "var(--color-background-tertiary, #f8fafc)" }}>
            ...
            <div style={{ fontSize: "0.68rem", color: "var(--color-text-secondary, #64748b)", lineHeight: 1.45 }}>
              Save tools, replay, balance bot y debugging viven aca, pero no deberian contaminar la lectura principal de progreso del jugador.
            </div>
          </div>
        )}
      </section>
